...
export default function Create() {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('admin.site-announcements.store'));
    };
        ...
        <AuthenticatedLayout
            header={
                <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
                    <div>
                        <h2 className="text-2xl font-bold leading-tight text-gray-800">New Site Announcement</h2>
                        <p className="text-sm text-gray-500">Display a banner on the public home page</p>
                    </div>
                </div>
            }
        >
            <Head title="New Site Announcement" />
