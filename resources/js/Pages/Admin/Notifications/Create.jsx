        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
                    <div>
                        <h2 className="text-2xl font-bold leading-tight text-gray-800">Create Notification</h2>
                        <p className="text-sm text-gray-500">Define channel, trigger, and message template</p>
                    </div>
                </div>
            }
        >
