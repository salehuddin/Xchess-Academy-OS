        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
                    <div>
                        <h2 className="text-2xl font-bold leading-tight text-foreground">Add New Coach</h2>
                        <p className="text-sm text-default-500">Create a new coach profile and user account</p>
                    </div>
                </div>
            }
        >
                ...
                <form onSubmit={handleSubmit}>
                    <Card className="mb-6">
                        <CardHeader className="pb-0 pt-4 px-4 flex-col items-start">
                            ...
                            <small className="text-default-500">Basic details and login credentials</small>
                        </CardHeader>
