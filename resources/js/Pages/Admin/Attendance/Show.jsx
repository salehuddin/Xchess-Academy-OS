...
export default function Show({ auth, schedule, students }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('admin.attendances.store', schedule.id));
    };
                ...
                <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
                    <div>
                        ...
                        <div className="flex items-center gap-2 text-sm text-gray-500 mt-1">
                            <Link href={route('admin.attendances.index')} className="hover:text-primary transition-colors">Attendance</Link>
                            <span className="text-gray-300">/</span>
                            <span className="font-medium text-gray-700">{schedule.class_name}</span>
                        </div>
                    </div>
                    <Button
                        as={Link}
