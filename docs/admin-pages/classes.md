...
- Resource routes: `admin.classes.*` via [web.php](routes/web.php#L44-L48)
- Additional routes:
...
- Backend controller: [Admin/ClassController](app/Http/Controllers/Admin/ClassController.php)
- Enrollment controller: [Admin/EnrollmentController](app/Http/Controllers/Admin/EnrollmentController.php)

## UI
- Index: [Admin/Classes/Index.jsx](resources/js/Pages/Admin/Classes/Index.jsx)
- Create: [Admin/Classes/Create.jsx](resources/js/Pages/Admin/Classes/Create.jsx)
- Show: [Admin/Classes/Show.jsx](resources/js/Pages/Admin/Classes/Show.jsx)
...
- Implemented as custom validation closures in [ClassController](app/Http/Controllers/Admin/ClassController.php#L71-L188)
...
- Implemented in [updateSchedules](app/Http/Controllers/Admin/ClassController.php#L200-L232)
...
## Technical Specs
### Data Model
- Class model: [ChessClass.php](app/Models/ChessClass.php)
- Key fields:
