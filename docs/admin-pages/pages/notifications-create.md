...
- Backend: [NotificationController@create/store](app/Http/Controllers/Admin/NotificationController.php#L108-L121)
- UI: [Admin/Notifications/Create.jsx](resources/js/Pages/Admin/Notifications/Create.jsx)
