...
- Resource routes: `admin.packages.*` via [web.php](routes/web.php#L88-L90)
- Access: `auth` + `role:Admin`
- Backend controller: [Admin/PackageController](app/Http/Controllers/Admin/PackageController.php)

## UI
- Page: [Admin/Packages/Index.jsx](resources/js/Pages/Admin/Packages/Index.jsx)
...
## Technical Specs
### Data Model
- Package model: [Package.php](app/Models/Package.php)
- Key fields:
  - `monthly_fee`
...
- Controller: [ScheduleController@store](app/Http/Controllers/Admin/ScheduleController.php#L129-L135)
